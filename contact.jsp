	...
	<div class="contact">
				...
				<form action="word" method="post">
					<h3>告诉我们的问题和意见</h3>
						<div>
							<label>你的用户名:</label>		
							<input name="Id" type="text" value="<s:property value="#attr.id"/>" disabled/>						
						</div>
						<div>
							<label>手机号码:</label>		
						...
						<div>
							<label>你的意见:</label>		
							<textarea name="feed.feedContent"> </textarea>	
						</div>
						<input class="center-block" type="submit" value="确认提交" >
				</form>
				</div>
				<div class="col-md-6 contact-top">
					<h3>悦心音乐的信息</h3>
					<ul class="social ">
						<li><span><i > </i>湖南省 长沙市 岳麓区 麓谷大道 辰泰科技园 </span></li>
						<li><span><i class="down"> </i>0731-1234567</span></li>
						<li><a href="mailto:YueXinMusic@mail.com"><i class="mes"> </i>YueXinMusic@mail.com</a></li>
					</ul>			
					<div class="map">
						<iframe src="yuexinMap.html"></iframe>
					</div>
				</div>
			<div class="clearfix"> </div>
			</div>
