...
<!--  -->
		...
		<!---->
			<p style="font-size:2em;" >欢迎来到！歌单界面</p>		
...
<script>
var musicList = [
<s:iterator value="#attr.cds.music" status="st">
    {
        title : "<s:property value="musicName" escape="false"/>",
        singer : "<s:property value="cd.singer.artist" escape="false"/>",
        cover  : "cd/<s:property value="cd.cdImg" escape="false"/>",
        src    : "music/<s:property value="song" escape="false"/>",
		lyric  : "music/<s:property value="lyric" escape="false"/>"
    },
    <s:if test="#st.isLast">
    	{
        title : "<s:property value="musicName" escape="false"/>",
        singer : "<s:property value="singer.artist" escape="false"/>",
        cover  : "musicDemo/src/data/<s:property value="cd.cdImg" escape="false"/>",
        src    : "musicDemo/src/data/<s:property value="song" escape="false"/>",
		lyric  : "musicDemo/src/data/<s:property value="lyric" escape="false"/>"
    }
    </s:if>
    </s:iterator>
     ];
...
<div class="row"><div class="col-md-12">
<!-- 多说评论框 start -->
	<div class="ds-thread" data-thread-key="b1bb6de4e38be8101e9706457062460b" data-title="音乐播放器页面" data-url="http://www.muyan67.cn/"></div>
<!-- 多说评论框 end -->
<!-- 多说公共JS代码 start (一个网页只需插入一次) -->
<script type="text/javascript">
var duoshuoQuery = {short_name:"muyan67"};
	(function() {
