...
<!--  -->
		...
		<!---->
			<p style="font-size:2em;" >欢迎来到！修改密码界面</p>			
	<ul class="nav nav-tabs">
  		...
  		<li style="font-size:24px;font-family: FontName" role="presentation" class="active"><a href="Demo3.jsp">修改密码</a></li>
	</ul>
	<div class="row"><div class="col-md-1">&nbsp;</div></div>
	<div class="row"><div class="col-md-1">&nbsp;</div></div>
	<div class="row"><div class="col-md-1">&nbsp;</div></div>
  	<form class="form-horizontal" action="updatePassword">
  		<input name="user.userId" type="hidden" value="<%=id%>"/>
  			<div class="form-group">
    			<label class="col-sm-4 control-label" style="font-size:20px;">旧密码：</label>
    			<div class="col-sm-8 input-group-lg">
      			<input name="user.userpassword" type="password"  class="form-control" style="width:300px;" id="" placeholder="请输入旧密码">
    			</div>
  			</div>
  			
 			<div class="form-group">
    			<label class="col-sm-4 control-label" style="font-size:20px;">新密码：</label>
    			<div class="col-sm-8 input-group-lg">
      			<input name="newpassword" type="password" class="form-control" style="width:300px;" id="" placeholder="请输入新密码">
    			</div>
  			</div>
