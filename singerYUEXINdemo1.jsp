...
<!--  -->
	...
	<img src="http://i.gtimg.cn/music/photo/mid_singer_300/e/k/003Nz2So3XXYek.jpg" class="img-thumbnail" alt="fotograph" title="" />	
	</div>
	<div class="col-xs-5">
	<strong style="font-size:2em;" >陈奕迅</strong><br><br>
	<h4>国　籍: 中国</h4><br>
	<h4>星　座: 狮子座</h4><br>
	<h4>血　型: O型</h4><br>
	<h4>出生日期: 1974年7月27日</h4><br>
	</div>
	<div class="col-xs-4">
	<strong style="font-family: FontName; font-size:1.5em; color:#777;" >简介:</strong><br><br>
	<p>陈奕迅（Eason Chan），1974年7月27日出生于香港，中国香港流行男歌手、演员，香港演艺人协会副会长之一，香港流行音乐张学友的接班人。 他1995年在香港参加TVB举办的第14届新秀歌唱大赛，从而跟华星唱片公司签下歌星合约，正式踏入香港乐坛。 1996年推出首张个人同名大碟《陈奕迅》，1998年推出《我的快乐时代》并获得首个叱吒乐坛流行榜颁奖典礼的“叱吒乐坛至尊唱片大奖”。</p>
	</div>
	<div class="clearfix"></div>
	 ...
	 <div class="card">
        ...
        <!-- 热门单曲 -->
          ...
          <div role="tabpanel" class="tab-pane" id="second">
            ...
            <img src="http://i.gtimg.cn/music/photo/mid_album_300/p/r/0041kwqW2zFapr.jpg" alt="..." class="img-thumbnail">
            <div class="ico_play"></div>    
            </div>
            <div style="color:#FF8200; width:130px; white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">Sleep Alone</div> 
			</div>
			
			<div class="col-xs-3" title="陪你度过漫长岁月">
            <div class="play_name111"> 
            <img src="http://i.gtimg.cn/music/photo/mid_album_300/H/I/002DAg4x3jVzHI.jpg" alt="..." class="img-thumbnail">
            <div class="ico_play"></div>    
            </div>
            <div style="color:#FF8200; width:130px; white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">陪你度过漫长岁月</div> 
			</div>
			
			<div class="col-xs-3" title="恐龙进化论">
            <div class="play_name111"> 
            <img src="http://i.gtimg.cn/music/photo/mid_album_300/u/v/002E4YWE2Sywuv.jpg" alt="..." class="img-thumbnail">
            <div class="ico_play"></div>    
            </div>
            <div style="color:#FF8200; width:130px; white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">恐龙进化论</div> 
			</div>
			
			<div class="col-xs-3" title="暴风雨">
            <div class="play_name111"> 
            <img src="http://i.gtimg.cn/music/photo/mid_album_300/P/p/003KjkGX4RIDPp.jpg" alt="..." class="img-thumbnail">
            <div class="ico_play"></div>    
            </div>
            <div style="color:#FF8200; width:130px; white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">暴风雨</div> 
			</div>
			...
			<div class="col-xs-3" title="rice & shine">
            <div class="play_name111"> 
            <img src="http://i.gtimg.cn/music/photo/mid_album_300/3/V/003rytri2FHG3V.jpg" alt="..." class="img-thumbnail">
            <div class="ico_play"></div>    
            </div>
            <div style="color:#FF8200; width:130px; white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">rice & shine</div> 
			</div>
			
			<div class="col-xs-3" title="斗战神">
            <div class="play_name111"> 
            <img src="http://i.gtimg.cn/music/photo/mid_album_300/j/q/002WHp9h2LYDjq.jpg" alt="..." class="img-thumbnail">
            <div class="ico_play"></div>    
            </div>
            <div style="color:#FF8200; width:130px; white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">斗战神</div> 
			</div>
			
			<div class="col-xs-3" title="主旋律之安魂曲">
            <div class="play_name111"> 
            <img src="http://i.gtimg.cn/music/photo/mid_album_300/l/v/00364Ck10bIalv.jpg" alt="..." class="img-thumbnail">
            <div class="ico_play"></div>    
            </div>
            <div style="color:#FF8200; width:130px; white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">主旋律之安魂曲</div> 
			</div>
			
			<div class="col-xs-3" title="Eason's Life 陈奕迅2013演唱会">
            <div class="play_name111"> 
            <img src="http://i.gtimg.cn/music/photo/mid_album_300/U/3/000bPFt10lCMU3.jpg" alt="..." class="img-thumbnail">
            <div class="ico_play"></div>    
            </div>
            <div style="color:#FF8200; width:130px; white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">Eason's Life 陈奕迅2013演唱会</div> 
			</div>
          ...
          <div role="tabpanel" class="tab-pane" id="third">
            <!-- 第一行mv -->
            <div class="row">
				<div class="col-xs-4" title="陈奕迅国语热门精选">
            		<div class="play_name222"> 
            			<img src="minCSS/SINGERcssANDjs/mqdefault.webp" alt="..." class="img-thumbnail">
            			<div class="ico_play222"></div>    
            		</div>
            			<div style="color:#FF8200; width:130px; white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">陈奕迅国语热门精选</div> 
				</div>
			
				<div class="col-xs-4" title="陈奕迅2013年演唱会">
            		<div class="play_name222"> 
            			<img src="minCSS/SINGERcssANDjs/mqdefault (1).webp" alt="..." class="img-thumbnail">
            			<div class="ico_play222"></div>    
            		</div>
            			<div style="color:#FF8200; width:130px; white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">陈奕迅2013年演唱会</div> 
				</div>
			
				<div class="col-xs-4" title="陈奕迅-《无条件》">
            		<div class="play_name222"> 
            			<img src="minCSS/SINGERcssANDjs/mqdefault (2).webp" alt="..." class="img-thumbnail">
            			<div class="ico_play222"></div>    
            		</div>
            		<div style="color:#FF8200; width:130px; white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">陈奕迅-《无条件》</div> 
				</div>	
			</div>
			<!-- //第一行mv -->
			<div class="row"><div class="col-md-1">&nbsp;</div></div>
			<!-- 第二行mv -->
			<div class="row">		
				<div class="col-xs-4" title="陈奕迅-《浮夸》">
            		<div class="play_name222"> 
            			<img src="minCSS/SINGERcssANDjs/mqdefault (3).webp" alt="..." class="img-thumbnail">
            			<div class="ico_play222"></div>    
            		</div>
            		<div style="color:#FF8200; width:130px; white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">陈奕迅-《浮夸》</div> 
				</div>
			
				<div class="col-xs-4" title="陈奕迅-《你给我听好》">
            		<div class="play_name222"> 
            			<img src="minCSS/SINGERcssANDjs/mqdefault.jpg" alt="..." class="img-thumbnail">
            			<div class="ico_play222"></div>    
            		</div>
            		<div style="color:#FF8200; width:130px; white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">陈奕迅-《你给我听好》</div> 
				</div>
			
				<div class="col-xs-4" title="陈奕迅《陀飞轮》">
            		<div class="play_name222"> 
            			<img src="minCSS/SINGERcssANDjs/mqdefault (4).webp" alt="..." class="img-thumbnail">
            			<div class="ico_play222"></div>    
            		</div>
            		<div style="color:#FF8200; width:130px; white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">陈奕迅《陀飞轮》</div> 
				</div>	
			</div>
            <!-- //第二行mv -->
          </div>
          ...
          <div role="tabpanel" class="tab-pane" id="fourth"> 
            <div class="row">  	
            <div class="col-md-12">
	<p>　　陈奕迅（Eason Chan），1974年7月27日出生于香港，中国香港流行男歌手、演员，香港演艺人协会副会长之一，香港流行音乐张学友的接班人。 他1995年在香港参加TVB举办的第14届新秀歌唱大赛，从而跟华星唱片公司签下歌星合约，正式踏入香港乐坛。 1996年推出首张个人同名大碟《陈奕迅》，1998年推出《我的快乐时代》并获得首个叱吒乐坛流行榜颁奖典礼的“叱吒乐坛至尊唱片大奖”。2003年他成为了第二个拿到台湾金曲奖“最佳国语男演唱人”的香港歌手。曾被美国《时代》杂志形容为影响香港乐坛风格的人物。2005年推出的专辑《U87》被《时代》杂志评为2005年亚洲五张最值得购买的专辑。2009年6月以《不想放手》获得金曲奖的奖项“最佳国语专辑”奖。 陈奕迅在影坛方面也有成就，2010年1月10日，他在“美涛·领衔2009腾讯网星光大典”中凭电影《金钱帝国》获得港台年度电影男演员荣誉。 2014年1月24日，陈奕迅获得英国金斯顿大学荣誉学位-。</p>
	<br><br>
