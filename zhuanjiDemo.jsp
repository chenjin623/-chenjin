...
<!--  -->
	...
	<h4>>>专辑>><s:property value="#attr.cds.cdName"/>>></h4>		
	<div class="row"><div class="col-md-1">&nbsp;</div></div>
	<div class="row">
	<div class="col-xs-3 text-right">
	<img src="cd/<s:property value="#attr.cds.cdImg"/>" class="img-thumbnail" alt="fotograph" title="" />	
	</div>
	<div class="col-xs-5">
	<strong style="font-size:2em;" ><s:property value="#attr.cds.cdName"/></strong><br><br>
	<h4>艺术家: <s:property value="#attr.cds.singer.artist"/></h4>
	<h4>风　格: <s:property value="#attr.cds.singer.style"/></h4>
	<!-- <h4>语　言: 英语</h4><br> -->
	<h4>发行时间: <s:date name="#attr.cds.releaseTime" format="yyyy年MM月dd日"/></h4><br>
	<h4>全部播放: <a href="playMusic?cd.cdId=<s:property value="#attr.cds.cdId"/>" type="button" class="btn btn-default btn-lg"><span class="glyphicon glyphicon-play"></span></a></h4>
	</div>
	
	
	<div class="col-xs-4">
	<strong style="font-family: FontName; font-size:1.5em; color:#777;" >简介:</strong><br><br>
	<p><s:property value="#attr.cds.cdIntroduction"/></p>
	</div>
	...
	<li class="list-group-item list-group-item-success"><span class="glyphicon glyphicon-cd" aria-hidden="true"></span>　CD1</li>
	<table class="table table-condensed table-hover">
			<thead>
              ...
              <tbody>
              	<s:iterator value="#attr.cds.music">
                <tr>
                  <td><s:property value="musicName"/></td>
                  <td>
                  	<a href="getAllReview?review.music.musicId=<s:property value="musicId"/>&review.music.MV=<s:property value="MV"/>">
                  ...
                  <td>
                  	<form action="downloads">
                  	  <input name="fileName" type="hidden" value="<s:property value="song"/>"/>
	...
	<div class="col-md-4">
	<p>　</p>
	<strong style="font-family: FontName; font-size:1.5em; color:#777;" >TA的其他专辑</strong><br><br>
		<%-- <s:action name="getCDBySingerId"/><s:property value="#attr.cds.singer.cd"/> --%>
		<s:iterator value="#attr.cds.singer.cd">
		<s:if test="cdId!=#attr.cds.cdId">
		<div class="might-grid">
			<div class="grid-might">
				<a href="single.jsp"><img src="cd/<s:property value="cdImg"/>" class="img-responsive img-thumbnail" alt=""> </a>
			</div>
			<div class="might-top">
				<p>&nbsp;&nbsp;&nbsp;专辑名称：<s:property value="cdName"/></p>
				<p>&nbsp;&nbsp;&nbsp;歌　　手：<s:property value="singer.artist"/></p> 
				<p>&nbsp;&nbsp;&nbsp;发行日期：<s:date name="releaseTime" format="yyyy年MM月dd日"/></p> 
				<a href="getCdInfo?cd.cdId=<s:property value="cdId"/>">&nbsp;&nbsp;&nbsp;点击查看 <i> </i></a>
			</div>
		<div class="clearfix"></div>
		</div>
		</s:if>
			...
			<!--bootstrap-->
			 <link href="timeCSSandJS/bootstrap.min.css" rel="stylesheet" type="text/css">
        <!--Date-Time-pickercss-->
            <link href="timeCSSandJS/bootstrap-datetimepicker.css" rel="stylesheet">
		<!--default-js-->
			<script src="timeCSSandJS/jquery-2.1.4.min.js"></script>
		<!--bootstrap-js-->
