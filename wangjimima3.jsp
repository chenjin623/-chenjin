...
<!--  -->
	...
	<form class="form-horizontal" onSubmit="return check();">
  			...
  			<div class="form-group">
    			...
    			<div class="col-sm-4">
 				<span style="position:relative;left:7px;color:#2ECC71;font-size:150px;" class="glyphicon glyphicon-ok-sign"></span>
    			</div>
  			</div>
  			...
  			<div class="form-group">
    			...
    			<div class="col-sm-4">
 				<h1 style="position:relative;left:65px">修改密码成功!</h1>
    			</div>
  			</div>
  	...
  	<div class="row"><div class="col-md-1">&nbsp;</div></div>					
    		...
    		<div class="col-sm-offset-2 col-sm-7">
      			<a href="wangjimima3.jsp" style="position:relative;left:50px;" type="submit" role="button" class="btn btn-lg btn-success" id="reg">好　　的</a>
    		</div>
  			</div>
  	</form>
