...
<html>
  <head>
    ...
    <title>NoaNealGraffiti360°视频</title>
...
<!--  -->
	...
	<div class="alert alert-danger alert-dismissible" role="alert">
		...
		<!---->
			...
			<p style="font-size:2.5em;" >Noa Neal - Graffiti</p>
...
<div id="container">
<video class="video-js vjs-default-skin" width="864" height="432" src="video/Graffiti.mp4" data-setup="{}" controls>
<source src="video/Graffiti.mp4" type="video/mp4">
</video>
</div>
    	...
    	<div class="col-md-6" style="left:80px">
    		<a href="#">	
				<button type="button" class="btn btn-default btn-lg" title="艺术家">
    				<span class="glyphicon glyphicon-user" aria-hidden="true"></span> Noa Neal
    			</button>
    		</a>
    	</div>
...
<!-- 多说评论框 start -->
	<div class="ds-thread" data-thread-key="b1bb6de4e38be8101e9706457062460a" data-title="360度视频" data-url="http://www.muyan67.cn/"></div>
<!-- 多说评论框 end -->
