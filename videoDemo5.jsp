...
<!--  -->
		...
		<!---->
			<p style="font-size:2.5em;" >王力宏 - 你的爱</p>
...
<div id="container">
  <video id="example_video_1" class="video-js vjs-default-skin" controls preload="none" width="864" height="432"
      poster="videoImages/nideaimp4.png"
      data-setup="{}">
    <source src="video/Your Love.mp4" type='video/mp4' />
    	...
    	<div class="col-md-8" style="left:80px">
    		<a href="#">	
				<button type="button" class="btn btn-default btn-lg" title="艺术家">
    				<span class="glyphicon glyphicon-user" aria-hidden="true"></span> 王力宏
    			</button>
    		</a>
    	</div>
