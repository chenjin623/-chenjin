...
<!--  -->
		...
		<!---->
			<p style="font-size:2.5em;" >Avril Lavigne - Girlfriend</p>
...
<div id="container">
  <video id="example_video_1" class="video-js vjs-default-skin" controls preload="none" width="864" height="432"
      ...
      data-setup="{}">
    <source src="video/Girlfriend.mp4" type='video/mp4' />
    	...
    	<div class="col-md-8" style="left:80px">
    		<a href="#">	
				<button type="button" class="btn btn-default btn-lg" title="艺术家">
    				<span class="glyphicon glyphicon-user" aria-hidden="true"></span> Avril Lavigne
    			</button>
    		</a>
    	</div>
