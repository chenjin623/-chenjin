...
<body>
	...
	<s:action name="singerName" executeResult="false"></s:action>
    <!-- sidebar -->
    <div id="sidebar-nav">
    ...
    <div class="content">
        ...
        <iframe src="index.jsp" frameBorder="0" width="100%" scrolling="no" height="2800"></iframe>
    ...
    <script src="back_js/jquery-ui-1.10.2.custom.min.js"></script>
    <!-- knob -->
    <script src="back_js/jquery.knob.js"></script>
    <!-- flot charts -->
    <script src="back_js/jquery.flot.js"></script>
    <script src="back_js/jquery.flot.stack.js"></script>
    <script src="back_js/jquery.flot.resize.js"></script>
