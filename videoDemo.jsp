...
<!--  -->
		...
		<!---->
			<p style="font-size:2.5em;" ><s:property value="#attr.mu.musicName"/></p>
...
<div id="container">
  <video id="example_video_1" class="video-js vjs-default-skin" controls preload="none" width="864" height="432"
      poster="videoImages/Griendmp4.png"
      data-setup="{}">
    <source src="music/<s:property value="#attr.MV"  escape="false"/>" type='video/mp4' />
   <!--  <source src="video/Walk This Way.mp4" type='video/mp4' /> -->
    	...
    	<div class="col-md-8" style="left:80px">
    		<a href="#">	
				<button type="button" class="btn btn-default btn-lg" title="艺术家">
    				<span class="glyphicon glyphicon-user" aria-hidden="true"></span> Aerosmith
    			</button>
    		</a>
    	</div>
...
<div class="row"><div class="col-md-1">&nbsp;</div></div>
<strong style="font-family: FontName; font-size:2em; color:#ff8200;">评论列表:</strong>
<div class="row">
<div class="col-md-8">
   <div class="comments-app pinglun" ng-app="commentsApp" ng-controller="CommentsController as cmntCtrl">
  
  <!-- 准备开始评论 -->
  <div class="comment-form">
    <!-- 开始评论头像 -->
    <div class="comment-avatar">
      <img src="http_imgload (3).jpg">
    </div>

    <<form action="addReview" class="form" name="form" ng-submit="form.$valid && cmntCtrl.addComment()" novalidate>
      <div class="form-row">
        <textarea
      ...
      <div class="form-row">
        <input
               ...
               placeholder="<s:property value="#attr.id"/>"
               type="text">
      </div>
		<input name="review.user.userId" type="hidden" value="<s:property value="#attr.id"/>"/>
		<input name="review.music.musicId" type="hidden" value="<s:property value="#attr.musicId"/>" >	
		<%-- <input name="review.music.musicId" type="text" value="<s:property value="#attr.mu.musicId"/>" > --%>
  ...
  <div class="comments">
    ...
    <div class="comment" ng-repeat="comment in cmntCtrl.comments | orderBy: '-date'">
      <!-- 生成评论头像 -->
      <div class="comment-avatar111">
        <img ng-src="{{ comment.avatarSrc }}">
      </div>

      <!-- 生成评论 -->
      <div class="comment-box111">
        <div class="comment-text">{{ comment.text }}</div>
        <div class="comment-footer">
          <div class="comment-info">
            <span class="comment-author">
              <em ng-if="comment.anonymous">匿名</em>
   ...
   <s:iterator value="#attr.list">
    <div class="comment">
      <!-- Comment Avatar -->
      <div class="comment-avatar">
        <img src="user/<s:property value="user.userImg"/>">
      </div>

      <!-- Comment Box -->
      <div class="comment-box">
        <div class="comment-text"><s:property value="reviewContent"/></div>
        <div class="comment-footer">
          <div class="comment-info">
            <span class="comment-author">
              <a href="mailto:sexar@pagelab.io"><s:property value="user.userId"/></a>
            </span>
            <span class="comment-date"><s:date name="reviewTime" format="yyyy年MM月dd日  HH:mm:ss"/></span>
          </div>
    ...
    <div class="comment">
      <!-- Comment Avatar -->
      <div class="comment-avatar">
        <img src="http://img2.imgtn.bdimg.com/it/u=1794383722,305562796&fm=21&gp=0.jpg">
      </div>

      <!-- Comment Box -->
      <div class="comment-box">
        <div class="comment-text">我是1号机器人！</div>
        <div class="comment-footer">
          <div class="comment-info">
            <span class="comment-author">
              <a href="mailto:ximme13@somedomain.io">1号机器人</a>
            </span>
            <span class="comment-date">2011年  8月 2日, 下午 11:32:04</span>
          </div>
...
<script src="minCSS/pinglunJS/angular.min.js"></script>
<script>
'use strict';
...
(function(){
  ...
  commentsApp.controller('CommentsController', ['$scope', function($scope){
    // Current comment.
    this.comment = {};
    ...
    this.addComment = function() {
      // Fixed img.
      this.comment.avatarSrc = "http_imgload (3).jpg";
