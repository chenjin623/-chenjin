...
<html>
  <head>
    <base href="<%=basePath%>">
<title>D'CinnamonsSweetMemories360°视频</title>
...
<!--  -->
	...
	<!---->
			...
			<h1 style="font-size:2.5em;" >D'Cinnamons - Sweet Memories</h1>
...
<div id="container">
<video class="video-js vjs-default-skin" width="864" height="432" src="video/D'Cinnamons - Sweet Memories.mp4" data-setup="{}" controls>
<source src="video/D'Cinnamons - Sweet Memories.mp4" type="video/mp4">
</video>
</div>
    	...
    	<div class="col-md-6" style="left:80px">
    		<a href="#">	
				<button type="button" class="btn btn-default btn-lg" title="艺术家">
    				<span class="glyphicon glyphicon-user" aria-hidden="true"></span> D'Cinnamons
    			</button>
    		</a>
    	</div>
