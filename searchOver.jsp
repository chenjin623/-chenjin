...
<!--  -->
		...
		<!---->
<p style="font-size:2em;" >搜索到的结果...</p><br>
<strong style="font-family: FontName; font-size:2em; color:#ff8200;">搜索结果:</strong><br>
<div style="height:4px;border-bottom:2px #ff8200 solid;"></div><br>
<div class="panel panel-default">
<div class="panel-heading" style="font-family: FontName; font-size:1.5em; color:#777;" >搜索结果列表</div>
              ...
              <tbody>
               ...
               %>
                <tr>
                  ...
                  <td>
                  	 <a href="getAllReview?review.music.musicId=<%=music.getMusicId() %>&review.music.MV=<%=music.getMV() %>">
                  ...
                  <td>
                      <form action="downloads">
                  	  <input name="fileName" type="hidden" value="<%=music.getSong() %>"/>
