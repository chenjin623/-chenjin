...
<!-- 全部艺术家 -->
	...
	<a href="#">
      <div class="image-box" title="李荣浩">
        <div class="image-content">
          <img src="http://i.gtimg.cn/music/photo/mid_singer_300/W/H/000aHmbL2aPXWH.jpg" />
          <div class="image-detail">
          </div>
        </div>
        <div style="color:#FF8200; width:130px; white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">李荣浩</div>
      </div>
    </a>			
    
    <a href="#">
      <div class="image-box" title="张信哲">
        <div class="image-content">
          <img src="http://i.gtimg.cn/music/photo/mid_singer_300/c/z/0000mFvh1jtLcz.jpg" />
          <div class="image-detail">
          </div>
        </div>
        <div style="color:#FF8200; width:130px; white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">张信哲</div>
      </div>
    </a>			
    ...
    <a href="#">
      <div class="image-box" title="张杰">
        <div class="image-content">
          <img src="http://i.gtimg.cn/music/photo/mid_singer_300/N/6/002azErJ0UcDN6.jpg" />
          <div class="image-detail">
          </div>
        </div>
        <div style="color:#FF8200; width:130px; white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">张杰</div>
      </div>
    </a>
