            ...
            <div id="pad-wrapper" class="new-user" style="margin-left:200px;">
                ...
                <div class="row-fluid form-wrapper">
                    ...
                    <div class="span9 with-sidebar">
                        <div class="container">
                            <form action="musicInfo" method="post" class="new_user_form inline-input" />
                                <div class="span12 field-box" style="margin-left:30px;">
                                    <label>歌曲名称:</label>
                                    <input class="span9" type="text" value="<s:property value="#attr.list.musicName"/>" readonly />
                                </div>
                                <div class="span12 field-box">
                                    <label>发布时间:</label>
                                    <input class="span9" type="text" value="<s:date name="#attr.list.releaseTime" format="yyyy-MM-dd"/>" readonly/>
                                </div>
                                <div class="span12 field-box">
                                    <label>下载量:</label>
                                    <input class="span9" type="text" value="<s:property value="#attr.list.downNum"/>" readonly/>
                                </div>
                                <div class="span12 field-box">
                                    <label>点击量:</label>
                                    <input class="span9" type="text" value="<s:property value="#attr.list.clickNum"/>" readonly/>
                                </div>
                                <div class="span12 field-box">
                                    <label>歌手名:</label>
                                    <input class="span9" type="text" value="<s:property value="#attr.list.cd.singer.artist"/>" readonly/>
                                </div>
                                 <div class="span12 field-box">
                                    <label>专辑名:</label>
                                    <input class="span9" type="text" value="<s:property value="#attr.list.cd.cdName"/>" readonly/>
                                </div>
                                <div class="span12 field-box">
                                    <label>语种:</label>
                                    <input class="span9" type="text" value="<s:property value="#attr.list.musiclanguage"/>" readonly/>
                                </div>
                            </form>
                        </div>
                    </div>
