...
<head>
    ...
    <link rel="stylesheet" href="back_css/compiled/new-user.css" type="text/css" media="screen" />
            ...
            <li>
             ...
             <li class="active">
                ...
                <ul class=" active submenu">
                    <li><a href="Integral.jsp" class="active">积分充值</a></li>
            ...
            <div id="pad-wrapper" class="new-user">
                ...
                <div class="row-fluid form-wrapper">
                    ...
                    <div class="span9 with-sidebar">
                        <div class="container">
                            <form action="addInteg" class="new_user_form inline-input"/>
                                <div class="span12 field-box">
                                    <label>用户名:</label>
                                    <input name="integral.userId" class="span9" type="text" />
                                </div>
                                
                                <div class="span12 field-box">
                                    <label>积分:</label>
                                    <input name="integral.integ" class="span9" type="text" />
                                </div>
                                <div class="span11 field-box actions">
                                    <input type="submit" class="btn-glow primary" value="充值" />
                                    <span>OR</span>
